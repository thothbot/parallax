...
public abstract class Shader
{
	...
	public Shader()
	{
		this(Parallax.files.classpath("org/parallax3d/parallax/renderers/shaders/default.vs").readString(),
		     Parallax.files.classpath("org/parallax3d/parallax/renderers/shaders/default.fs").readString());
	}

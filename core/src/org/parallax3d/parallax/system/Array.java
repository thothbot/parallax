...
public class Array<T> implements Iterable<T> {
	 ...
	 * array must have a size greater than 0, or will be thrown.
	 * @see Select
	...
	public T selectRanked (Comparator<T> comparator, int kthLowest) {
		if (kthLowest < 1) {
			throw new ParallaxRuntimeException("nth_lowest must be greater than 0, 1 = first, 2 = second...");
		}
...
// System.out.println(iterable.lastAcquire);
				throw new ParallaxRuntimeException("#iterator() cannot be used nested.");
			}
...
// System.out.println(iterable.lastAcquire);
		...
		public void remove () {
			if (!allowRemove) throw new ParallaxRuntimeException("Remove not allowed.");
			index--;

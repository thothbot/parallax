 ...
 * NSMutableDictionary will be written to the given file). CAUTION: On the desktop platforms, all libgdx applications share the same
 ...
 * 
 * <p>
 * Use {@link Application#getPreferences(String)} to look up a specific preferences instance. Note that on several platforms the

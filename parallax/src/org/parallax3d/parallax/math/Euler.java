...
public class Euler {
	...
	public Euler setFromRotationMatrix( Matrix4 m, String order )
	{
		...
		if ( order.equals("XYZ") ) {
			...
			App.app.error("Euler", "Euler: .setFromRotationMatrix() given unsupported order: " + order);
	...
	public Euler setFromQuaternion ( Quaternion q, String order, boolean update ) {
		...
		if ( order.equals("XYZ") ) {
			...
			App.app.error("Euler", "Euler: .setFromQuaternion() given unsupported order: " + order );

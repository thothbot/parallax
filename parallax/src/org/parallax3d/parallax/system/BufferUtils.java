...
public final class BufferUtils {
    ...
    public static void transform (Buffer data, int dimensions, int strideInBytes, int count, Matrix4 matrix, int offset) {
        switch (dimensions) {
            case 4:
                transformV4M4Jni(data, strideInBytes, count, matrix.getArray(), positionInBytes(data) + offset);
                break;
            case 3:
                transformV3M4Jni(data, strideInBytes, count, matrix.getArray(), positionInBytes(data) + offset);
                break;
            case 2:
                transformV2M4Jni(data, strideInBytes, count, matrix.getArray(), positionInBytes(data) + offset);
                break;
            default:
    ...
    public static void transform (float[] data, int dimensions, int strideInBytes, int count, Matrix4 matrix, int offset) {
        switch (dimensions) {
            case 4:
                transformV4M4Jni(data, strideInBytes, count, matrix.getArray(), offset);
                break;
            case 3:
                transformV3M4Jni(data, strideInBytes, count, matrix.getArray(), offset);
                break;
            case 2:
                transformV2M4Jni(data, strideInBytes, count, matrix.getArray(), offset);
                break;
            default:
                throw new IllegalArgumentException();
        }
    ...
    public static void transform (Buffer data, int dimensions, int strideInBytes, int count, Matrix3 matrix, int offset) {
        switch (dimensions) {
            case 3:
                transformV3M3Jni(data, strideInBytes, count, matrix.getArray(), positionInBytes(data) + offset);
                break;
            case 2:
                transformV2M3Jni(data, strideInBytes, count, matrix.getArray(), positionInBytes(data) + offset);
                break;
            default:
                throw new IllegalArgumentException();
        }
    ...
    public static void transform (float[] data, int dimensions, int strideInBytes, int count, Matrix3 matrix, int offset) {
        switch (dimensions) {
            case 3:
                transformV3M3Jni(data, strideInBytes, count, matrix.getArray(), offset);
                break;
            case 2:
                transformV2M3Jni(data, strideInBytes, count, matrix.getArray(), offset);
                break;
            default:
                throw new IllegalArgumentException();
        }
    ...
    private static int positionInBytes (Buffer dst) {
        if (dst instanceof ByteBuffer)
            ...
            throw new ParallaxRuntimeException("Can't copy to a " + dst.getClass().getName() + " instance");
    }

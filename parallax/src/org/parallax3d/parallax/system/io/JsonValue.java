...
package org.parallax3d.parallax.system.io;
...
public class JsonValue implements Iterable<JsonValue> {
	...
	public String toString () {
		...
		return (name == null ? "" : name + ": ") + prettyPrint(JsonWriter.OutputType.minimal, 0);
	}
			...
			if (object.child == null)
				...
				while (true) {
					...
					for (JsonValue child = object.child; child != null; child = child.next) {
						...
						if ((!newLines || outputType != JsonWriter.OutputType.minimal) && child.next != null) buffer.append(',');
						buffer.append(newLines ? '\n' : ' ');

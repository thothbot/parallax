 ...
 * the License.
 */
package org.parallax3d.parallax.system.jsonbind.vm.impl;

import org.parallax3d.parallax.system.jsonbind.AutoBean;
import org.parallax3d.parallax.system.jsonbind.AutoBeanFactory;
import org.parallax3d.parallax.system.jsonbind.AutoBeanUtils;
import org.parallax3d.parallax.system.jsonbind.vm.Configuration;
...
public class FactoryHandler implements InvocationHandler {
   ...
   * Constructor.
   * 
   * @param configuration the classes specified by a Category annotation
   */
  ...
  private Object getEnum(Class<?> clazz, String token)
    ...
    for (Field f : clazz.getFields()) {
      String fieldName;
      AutoBean.PropertyName annotation = f.getAnnotation(AutoBean.PropertyName.class);
      if (annotation != null) {
  ...
  private Object getToken(Enum<?> e) throws NoSuchFieldException {
    ...
    AutoBean.PropertyName annotation = e.getDeclaringClass().getField(e.name()).getAnnotation(
        AutoBean.PropertyName.class);
    if (annotation != null) {

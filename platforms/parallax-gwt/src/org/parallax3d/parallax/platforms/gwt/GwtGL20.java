...
//			return ((Float32Array)((HasArrayBufferView)buffer).getTypedArray()).subarray(buffer.position(), buffer.remaining());
	...
	public void glReadPixels (int x, int y, int width, int height, int format, int type, Buffer pixels) {
		...
		if ((format != WebGLRenderingContext.RGBA) || (type != WebGLRenderingContext.UNSIGNED_BYTE)) {
			throw new ParallaxRuntimeException("Only format RGBA and type UNSIGNED_BYTE are currently supported for glReadPixels(...).");
		}
		if (!(pixels instanceof ByteBuffer)) {
			throw new ParallaxRuntimeException("Inputed pixels buffer needs to be of type ByteBuffer for glReadPixels(...).");
		}
	...
	public void glGetAttachedShaders (int program, int maxcount, Buffer count, IntBuffer shaders) {
		// FIXME
		throw new ParallaxRuntimeException("not implemented");
	}
	...
	public void glGetBooleanv (int pname, Buffer params) {
		throw new ParallaxRuntimeException("glGetBoolean not supported by GWT WebGL backend");
	}
	...
	public void glGetFloatv (int pname, FloatBuffer params) {
		if (pname == GL20.GL_DEPTH_CLEAR_VALUE || pname == GL20.GL_LINE_WIDTH || pname == GL20.GL_POLYGON_OFFSET_FACTOR
			...
			throw new ParallaxRuntimeException("glGetFloatv not supported by GWT WebGL backend");
	}
	...
	public void glGetTexParameterfv (int target, int pname, FloatBuffer params) {
		throw new ParallaxRuntimeException("glGetTexParameter not supported by GWT WebGL backend");
	}
	...
	public void glGetVertexAttribPointerv (int index, int pname, Buffer pointer) {
		throw new ParallaxRuntimeException("glGetVertexAttribPointer not supported by GWT WebGL backend");
	}
	...
	public void glShaderBinary (int n, IntBuffer shaders, int binaryformat, Buffer binary, int length) {
		throw new ParallaxRuntimeException("glShaderBinary not supported by GWT WebGL backend");
	}
	...
	public void glVertexAttribPointer (int indx, int size, int type, boolean normalized, int stride, Buffer ptr) {
		throw new ParallaxRuntimeException("not implemented, vertex arrays aren't support in WebGL it seems");
	}

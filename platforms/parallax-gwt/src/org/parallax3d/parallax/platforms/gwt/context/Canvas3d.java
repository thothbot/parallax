...
public class Canvas3d extends FocusWidget 
{
	 ...
	 * @param attributes GL
	 * 			Canvas attributes, represented in {@link WebGLContextAttributes}.
	 *
	 * @throws ParallaxRuntimeException
	 */
	public Canvas3d(WebGLContextAttributes attributes) throws Exception
	{
...
//				Log.error("3d context: " + contextId + ", " + e.getMessage());
		...
		if( gl == null )
			throw new ParallaxRuntimeException("GL context can not be initialized. ");
	}

...
public class AutoBeanMethod {
  ...
  public static class Builder {
    ...
    public AutoBeanMethod build() {
      if (toReturn.action.equals(JBeanMethod.GET)
        ...
        AutoBean.PropertyName annotation = toReturn.method.getAnnotation(AutoBean.PropertyName.class);
        if (annotation != null) {
  ...
  static String getEnumName(JEnumConstant e) {
    String name;
    AutoBean.PropertyName annotation = e.getAnnotation(AutoBean.PropertyName.class);
    if (annotation == null) {
      name = e.getName();
    } else {

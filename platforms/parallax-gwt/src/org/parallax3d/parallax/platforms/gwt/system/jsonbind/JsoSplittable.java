...
public final class JsoSplittable extends JavaScriptObject implements Splittable, HasSplittable {
  ...
  private native JsoSplittable getRaw(int index) /*-{
    ...
    if (@org.parallax3d.parallax.platforms.gwt.system.jsonbind.JsoSplittable::isUnwrappedString(*)(_)) {
      return @org.parallax3d.parallax.platforms.gwt.system.jsonbind.JsoSplittable::create(Ljava/lang/String;)(_);
    }
    return Object(_);
  }-*/;

...
import thothbot.parallax.core.shared.core.ShapeGeometry;
...
{
	private final List< Path > holes = new ArrayList< Path >();
	...
	public List< List< Vector2 > > getPointsHoles ( final boolean closedPath )
	{
		...
		final List< List< Vector2 > > holesPts = new ArrayList< List< Vector2 > >();
